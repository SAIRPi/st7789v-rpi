...
![RPi System Stats Display](http://kron.penthux.net/sairpi/img/jaffaworks/maia_slackpunk_display.jpg)

### Display Raspberry Pi 5 system status on-the-fly

    python3 rpi_system_stats.py
	
![RPi System Stats Display](http://kron.penthux.net/sairpi/img/jaffaworks/maia_system_stats_display.jpg)

### Run Matrix -style digital rain generator script

    python3 matrix_digital_rain.py
	
![RPi System Stats Display](http://kron.penthux.net/sairpi/img/jaffaworks/maia_matrix_digital_rain.jpg)
